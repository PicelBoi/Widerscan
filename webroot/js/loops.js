...
function Loops() {
	...
	function refreshObservationDisplay() {
		...
		if (weatherInfo.currentCond.sidebar.noReport == true) {
			...
			$('#tmrw-info').fadeIn(0)
			$('#tmrw-title').fadeIn(0)
			$('#tonight-temp').fadeIn(0)
			$('#tonight-info').fadeIn(0)
			$('#tonight-title').fadeIn(0)
			...
			getCCicon('#tmrw-conditions-icon', weatherInfo.fiveDay.lowerbar.day[1].icon, weatherInfo.fiveDay.lowerbar.day[1].windspeed)
			getCCicon('#tonight-conditions-icon', weatherInfo.fiveDay.lowerbar.day[0].icon, weatherInfo.fiveDay.lowerbar.day[0].windspeed)
